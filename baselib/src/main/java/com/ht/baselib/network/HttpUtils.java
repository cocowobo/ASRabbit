...
public class HttpUtils {
     ...
     */
    public String post(String actionUrl, Map<String, String> header, Map<String, Object> params)
            throws Exception {
...
//                    LogUtils.v("请求头设置:" + entry.getKey() + " = " + entry.getValue());
     ...
     * @param actionUrl 请求地址
     * @param header    请求头
     * @param reqBody   POST参数
     * @return
     * @throws Exception 网络请求异常,其中状码码非200时抛出异常
     */
    public String post(String actionUrl, Map<String, String> header, String reqBody)
            throws Exception {
        LogUtils.v("post------------- actionUrl = " + actionUrl);
        HttpURLConnection urlConn = null;
        BufferedReader br = null;
...
//                    LogUtils.v("请求头设置:" + entry.getKey() + " = " + entry.getValue());
            ...
            /********************************************************************/
//            LogUtils.v("post------------- param = " + reqBody.toString());
            byte[] bypes = reqBody.getBytes();
            DataOutputStream dos = new DataOutputStream(urlConn.getOutputStream());
            dos.write(bypes);// 输入参数
            dos.flush();
            dos.close();
