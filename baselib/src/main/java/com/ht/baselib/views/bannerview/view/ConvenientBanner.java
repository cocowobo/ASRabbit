package com.ht.baselib.views.bannerview.view;
...
import com.ht.baselib.views.bannerview.adapter.CBPageAdapter;
import com.ht.baselib.views.bannerview.holder.CBViewHolderCreator;
import com.ht.baselib.views.bannerview.listener.CBPageChangeListener;
import com.ht.baselib.views.bannerview.listener.OnBannerItemClickListener;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    /**
     * 设置指示器 点点的间距
     * 必须在 setPageIndicator前调用 否则不生效
     *
     * @param xDp
     * @return
     */
    public ConvenientBanner setPageIndicatorMargin(int xDp) {
        pointMargin = LocalDisplay.dp2px(xDp) / 2;
        return this;
    }
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointView.setPadding(pointMargin, 0, pointMargin, 0);
     ...
     * @param yDp   指示器上下左右的间距值 单位dp
     * @return
     */
    public ConvenientBanner setPageIndicatorAlign(PageIndicatorAlign align, int yDp) {
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) loPageTurningPoint.getLayoutParams();
        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT, align == PageIndicatorAlign.ALIGN_PARENT_LEFT ? RelativeLayout.TRUE : 0);
        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT, align == PageIndicatorAlign.ALIGN_PARENT_RIGHT ? RelativeLayout.TRUE : 0);
        layoutParams.addRule(RelativeLayout.CENTER_HORIZONTAL, align == PageIndicatorAlign.CENTER_HORIZONTAL ? RelativeLayout.TRUE : 0);
        int x = LocalDisplay.dp2px(yDp);
        layoutParams.setMargins(x / 2, x, x / 2, x);
     ...
     */
    public ConvenientBanner setOnBannerItemClickListener(OnBannerItemClickListener onItemClickListener) {
