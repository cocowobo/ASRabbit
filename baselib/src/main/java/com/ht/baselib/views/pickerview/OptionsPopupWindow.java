...
import com.ht.baselib.views.pickerview.subview.WheelOptions;
...
public class OptionsPopupWindow extends PopupWindow implements OnClickListener {
    ...
    /**
     * 设置选项（两列）
     * @param options1Items 选项1内容
     * @param options2Items 选项2内容
     * @param linkage 是否联动：true是，false否
     */
     ...
     * 设置选中的item位置
     *
     * @param option1 第一列选中item位置索引
     * @param option2 第二列选中item位置索引
     */
    ...
    public interface OnOptionsSelectListener {
        /**
         * 选项选择监听方法
         * @param options1 第一列选中item位置索引
         * @param option2  第二列选中item位置索引
         * @param options3 第三列选中item位置索引
         */
    ...
    /**
     * 设置选项选择监听
     * @param optionsSelectListener 选项选择监听
     */
