...
import com.ht.baselib.views.pulltorefresh.ILoadingLayout;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
     ...
     * 猫头鹰 刷新图标新增功能代码修改
     */
    protected Drawable refreshingDrawable;
    protected Drawable releaseDrawable;
    protected Drawable pullDrawable;
    ...
    public void setReleaseDrawable(Drawable releaseDrawable) {
        this.releaseDrawable = releaseDrawable;
    }

    public void setPullDrawable(Drawable pullDrawable) {
        this.pullDrawable = pullDrawable;
    }
