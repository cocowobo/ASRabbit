...
package com.ht.baselib.views.wheelview;
...
import com.ht.baselib.views.wheelview.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    /**
     * Set whether Triangle
     *
     * @param drawTriangle flag as true or false
     */
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.ht_wheel_line_border));
        ...
        if (drawTriangle) {
            ...
            path3.moveTo(LocalDisplay.dp2px(28), center - LocalDisplay.dp2px(9));
            path3.lineTo(LocalDisplay.dp2px(39), center);
            path3.lineTo(LocalDisplay.dp2px(28), center + LocalDisplay.dp2px(9));
            path3.close();
