...
public class PermissionsActivity extends BaseActivity {
    ...
    @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        backgroundView.setBackgroundColor(getResources().getColor(R.color.ht_global_main));
    ...
    private void showMissingPermissionDialog() {
        CustomDialog customDialog = CustomDialog.newConfirmInstance(mContext);
        customDialog.setTitle(R.string.help);
        customDialog.setContent(getString(R.string.string_help_text));
        customDialog.setConfirmBtnText(getString(R.string.settings));
        customDialog.setCancelBtnText(getString(R.string.quit));
